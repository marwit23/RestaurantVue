<template>
  <b-container class="container-sm mb-4 custom-width-1">
    ...
    <table class="table smaller-font border-bottom border-top-hidden">
      ...
      <tbody>
        <tr
          v-for="deliveryItem in tempDelivery.deliveryItems"
            ...
            <b-form inline @submit="onSubmit">
              <b-input-group>
                <b-form-input
                  ...
                  :class="[
                    {
                      red: deliveryItem.deliveredQuantity == 0,
                    },
                  ]"
                  class="form-control"
    ...
    <div class="mt-4">
      ...
      <b-button type="submit" variant="warning" class="ml-2" @click="onSubmit"
        >Submit</b-button
      >
    </div>
  </b-container>
