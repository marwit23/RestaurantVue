<template>
    <b-modal id="edit-ingredient-modal" ref="edit-ingredient-modal" okTitle="Save" okVariant="success" @ok="onSubmit" @hidden="resetModal" :propIngredient="propIngredient">
        <b-container class="container-sm">
            ...
            <b-form @submit="onSubmit">
                ...
                <b-form-group label="Ingredient name" label-for="ingredientName">
                    ...
                    <span v-if="!$v.ingredient.ingredientName.isUnique && $v.ingredient.ingredientName.$dirty" class="text-danger">Such item already exists in the database!</span>
                </b-form-group>
                ...
                <b-form-group label="Category" label-for="ingredientCategegory">
                    ...
                    <span v-if="!$v.ingredient.ingredientCategory.required && $v.ingredient.ingredientName.$dirty" class="text-danger">Category cannot be empty</span>
                </b-form-group>
                ...
                <b-form-group label="Shelf life" label-for="shelfLife">
                    ...
                    <span v-if="!$v.ingredient.shelfLife.required && $v.ingredient.shelfLife.$dirty" class="text-danger">Shelf life cannot be empty!</span>
