<template>
    <div>
        ...
        <table class="table smaller-font">
            ...
            <tbody>
                <tr v-for="ingredient in paginatedData" :key="ingredient.ingredientId">
                    <td>
                        <b-button v-b-modal.edit-ingredient-modal @click="setIngredient(ingredient)" class="btn btn-light btn-sm ml-2">Edit
                        </b-button>
                        <b-button v-b-modal.modal-1 @click="setIngredient(ingredient)" class="btn btn-light btn-sm ml-2">Delete</b-button>
                    </td>
        ...
        <b-modal id="modal-1" okVariant="danger" okTitle="Delete" @ok="deleteIngredient(tempIngredient.ingredientId)">
            <h5 class="mb-4">Confirm delete Ingredient ID: {{tempIngredient.ingredientName}}</h5>
...
export default {
    ...
    computed: {
        ...mapGetters(["allIngredients", "ingredientById"]),
    ...
    methods: {
        ...mapActions(["getAllIngredients", "addIngredient", "deleteIngredient", "editIngredient"]),
