  ...
  <div>
    ...
    <table class="table smaller-font">
      <thead>
        <tr class="">
          <th>
            <b-button v-b-modal.add-ingredient-modal variant="warning ml-2"
              >Add New</b-button
            >
          </th>
          <th>Id</th>
    ...
    <b-modal id="modal-1" ok-only okVariant="warning" okTitle="OK">
      ...
      <p class="my-4">Unable to delete. This ingredient is in use!</p>
    </b-modal>
  ...
  computed: {
    ...
    filteredList() {
      return this.searchList.filter((ingredient) => {
        return ingredient.ingredientCategory.includes(
