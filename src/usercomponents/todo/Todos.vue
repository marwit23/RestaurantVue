<template>
    <div class="container">
        <div class="row mt-4">
            ...
            <b-col class="col-11">
                <transition-group name="list-complete">
                    <div
                        ...
                        :class="[
                            { 'border-danger': todo.toDoStatus == 'OPENED' },
                        ]"
                        v-for="todo in todosSorted"
                        :key="todo.toDoDishId"
                    >
                        <div class="card-header">
                            Order id: {{ todo.toDoDishId }}
                        </div>
                        <div class="card-body">
                            <b-row>
                                <b-col
                        ...
                        <div class="card-footer">
                            <b-row>
                                ...
                                <b-col>
                                    ...
                                    <div
                                        v-else-if="todo.toDoStatus == 'OPENED'"
                                    >
                                        <b-button
            ...
            >
                <h5 class="mb-4">
                    Confirm delete order ID: {{ tempTodo.toDoDishId }}
                </h5>
                <p class="my-4">
...
export default {
    ...
    computed: {
        ...
        todosWaitingArray() {
            return this.todosCopy.filter(
                (todo) => todo.toDoStatus == "WAITING"
            );
        },
        todosCompletedArray() {
            return this.todosCopy.filter(
